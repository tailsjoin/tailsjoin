...
echo -e "\n\nSCRIPT FINISHED.\n"
echo "YOU CAN RUN BITCOIN BY ENTERING THE FOLDER:"
echo " $PWD/bitcoin-0.11.0/bin"
echo -e "AND DO:   ./bitcoind -conf=/path/to/bitcoin-0.11.0/bin/bitcoin.conf\n\n"
echo "YOU MUST NOW ENTER YOUR DATA DIR IN THE BITCOIN CONFIG FILE."
echo -e "EXAMPLE ENTRY:   datadir=/media/mounted_device/.bitcoin/\n\n"
